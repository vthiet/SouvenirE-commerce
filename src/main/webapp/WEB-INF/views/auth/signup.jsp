...
<head>
    ...
    <title><fmt:message key="auth.signup.title"/></title>
...
<main class="auth-shell signup-shell">
    <aside class="auth-media" aria-label="<fmt:message key='auth.signup.media_aria'/>">
        <img src="${pageContext.request.contextPath}/assets/images/products/lang-nghe-thu-cong/bo-am-chen-bach-ngoc-hoa-sen-qua-tang-cao-cap.jpg" alt="<fmt:message key='auth.signup.media_title'/>">
        <div class="media-caption">
            <strong><fmt:message key="auth.signup.media_title"/></strong>
            <span><fmt:message key="auth.signup.media_text"/></span>
        </div>
    </aside>

    <section class="auth-panel">
        <a class="brand-link" href="${pageContext.request.contextPath}/home" aria-label="<fmt:message key='auth.signup.brand_aria'/>">
            <img src="${pageContext.request.contextPath}/assets/images/logo.png" alt="<fmt:message key='site.name'/>">
        </a>

        <div class="auth-copy">
            <p class="eyebrow"><fmt:message key="auth.signup.eyebrow"/></p>
            <h1><fmt:message key="auth.signup.heading"/></h1>
            <p class="supporting-text"><fmt:message key="auth.signup.supporting"/></p>
        </div>

        <div class="step-indicator" aria-label="<fmt:message key='auth.signup.step_indicator'/>">
            <div class="step active" id="step1">
                <span>1</span>
                <small><fmt:message key="auth.signup.step1"/></small>
            </div>
            <div class="step" id="step2">
                <span>2</span>
                <small><fmt:message key="auth.signup.step2"/></small>
            </div>
            <div class="step" id="step3">
                <span>3</span>
                <small><fmt:message key="auth.signup.step3"/></small>
            </div>
        </div>
        ...
        <form class="signup-form" id="signupForm">
            <div class="form-step active" id="step1Content">
                <label class="field">
                    <span><fmt:message key="auth.signup.email_label"/></span>
                ...
                <div class="loading" id="emailCheckLoading">
                    ...
                    <span><fmt:message key="auth.signup.email_checking"/></span>
                </div>
                ...
                <button type="button" class="primary-button" id="continueBtn">
                    <span><fmt:message key="auth.signup.continue"/></span>
                    <i class="fa fa-arrow-right"></i>
                </button>

                <p class="switch-link">
                    <fmt:message key="auth.signup.has_account"/>
                    <a href="${pageContext.request.contextPath}/login"><fmt:message key="auth.signup.login_link"/></a>
                </p>
            </div>

            <div class="form-step" id="step2Content">
                <div class="verified-email-card">
                    <span><fmt:message key="auth.signup.selected_email"/></span>
                    <strong id="selectedEmail"></strong>
                </div>

                <label class="field">
                    <span><fmt:message key="auth.signup.code_label"/></span>
                    <span class="otp-row">
                        <span class="input-wrap">
                        ...
                        <button type="button" class="secondary-button inline-button" id="sendCodeBtn">
                            ...
                            <span><fmt:message key="auth.signup.send_code"/></span>
                        </button>
                    </span>
                </label>
                ...
                <div class="button-grid">
                    <button type="button" class="secondary-button" id="backToEmailBtn">
                        ...
                        <span><fmt:message key="auth.signup.back"/></span>
                    </button>
                    <button type="button" class="primary-button" id="verifyCodeBtn">
                        <i class="fa fa-check"></i>
                        <span><fmt:message key="auth.signup.verify"/></span>
                    </button>
                </div>
            </div>
            ...
            <div class="form-step" id="step3Content">
                <div class="name-grid">
                    <label class="field">
                        <span><fmt:message key="auth.signup.last_name"/></span>
                        <span class="input-wrap">
                    ...
                    <label class="field">
                        <span><fmt:message key="auth.signup.first_name"/></span>
                        <span class="input-wrap">
                            <i class="fa fa-user"></i>
                ...
                <label class="field">
                    <span><fmt:message key="auth.signup.phone"/></span>
                    <span class="input-wrap">
                ...
                <fieldset class="field gender-field">
                    <legend><fmt:message key="auth.signup.gender"/></legend>
                    <div class="gender-options">
                        <label>
                            <input type="radio" name="gender" value="MALE" checked>
                            <span><fmt:message key="auth.signup.gender.male"/></span>
                        </label>
                        <label>
                            <input type="radio" name="gender" value="FEMALE">
                            <span><fmt:message key="auth.signup.gender.female"/></span>
                        </label>
                        <label>
                            <input type="radio" name="gender" value="OTHER">
                            <span><fmt:message key="auth.signup.gender.other"/></span>
                        </label>
                    </div>
                </fieldset>

                <label class="field">
                    <span><fmt:message key="auth.signup.password"/></span>
                ...
                <label class="field">
                    <span><fmt:message key="auth.signup.confirm_password"/></span>
                    <span class="input-wrap password-wrap">
                        <i class="fa fa-lock"></i>
                ...
                <div class="loading" id="submitLoading">
                    <div class="spinner"></div>
                    <span><fmt:message key="auth.signup.submitting"/></span>
                </div>
                ...
                <div class="button-grid">
                    ...
                    <button type="button" class="primary-button" id="submitBtn">
                        ...
                        <span><fmt:message key="auth.signup.submit"/></span>
                    </button>
                </div>
            </div>
        </form>
...
<script>
    ...
    window.authI18n = {
        ...
        signupVerified: '<fmt:message key="auth.js.signup_verified"/>',
        signupSuccess: '<fmt:message key="auth.js.signup_success"/>',
        signupTimeout: '<fmt:message key="auth.js.signup_timeout"/>',
        ...
        emailNotVerified: '<fmt:message key="auth.js.email_not_verified_signup"/>',
        firstNameRequired: '<fmt:message key="auth.js.first_name_required"/>',
        lastNameRequired: '<fmt:message key="auth.js.last_name_required"/>',
        phoneInvalid: '<fmt:message key="auth.js.phone_invalid"/>',
        genderRequired: '<fmt:message key="auth.js.gender_required"/>',
        passwordMismatch: '<fmt:message key="auth.js.password_mismatch"/>',
