    ...
    public void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            AuditLogService.success(
                    LoginGithubServlet.class,
                    user,
                    "AUTH",
                    "LOGIN_GITHUB",
                    "SESSION",
                    AuditLogService.describe("method", "github", "redirect", redirectTarget)
            );
            ...
            req.getSession(true).setAttribute("error", I18nUtil.message(req, "auth.server.login.oauth_github_failed"));
